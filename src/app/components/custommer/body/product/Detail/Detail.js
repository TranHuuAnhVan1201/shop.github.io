        ...
        return (
            <div>
                <ul className="breadcrumb">
                    <li>
                        <Link to="/">
                            {this.props.categoryBeadcrumb}
                        </Link>
                        <span>›</span>
                    </li>
                    <li>
                        <Link to="/">
                            {this.props.companyBeadcrumb}
                        </Link>
                    </li>
                </ul>
                ...
                <div className="rowdetail">
                    ...
                    <div className="icon-position">
                        <img width={400} height={400} src={this.props.pictures} alt="pictures" />
                    ...
                    <div className="colorandpic">
                        ...
                        <li>
                            <div>
                            <img className src="https://cdn.tgdd.vn/Products/Images/522/223131/huawei-matepad-t8-xanh-200x200.jpg" alt="1" />
                            </div>
                            Xanh Dương
                        </li>
                    ...
                    <div className="h-province dt detail scenario0" data-scenario={0} data-sv="TGDD6-15">
                        ...
                        <strong>{this.props.price}</strong>
                                <span className="hisprice">{this.props.priceSale}</span>
                        <i>-9%</i>            
                        <span />
                        </div>
                                        ...
                                        <div className="owl-warpper" style={{ left: 0, display: 'block', transition: 'all 0ms ease 0s', transform: 'translate3d(0px, 0px, 0px)'}}>
                                            {
                                                dataProduct.map((value, key) => {
                                                    if (value.id !== this.props.idRelated) {
                                                        return (
                                                            <Owl_Item key={key}
                                                                idProduct ={value.id}
                                                                review={value.review}
